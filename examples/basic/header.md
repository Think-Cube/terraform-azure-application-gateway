# Example: Basic — Azure Application Gateway

Provisions an Azure Application Gateway with configurable listeners and routing rules. Minimal example using required inputs only.
