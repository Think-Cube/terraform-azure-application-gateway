# Example: Advanced — Azure Application Gateway

Provisions an Azure Application Gateway with configurable listeners and routing rules. Full-featured example with optional configuration blocks enabled.
